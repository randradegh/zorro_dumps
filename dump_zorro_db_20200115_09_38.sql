...
166	SVTC	Venta de Carpio	2	\N	\N	\N	\N	15	27	\N	\N
\.
...
SELECT pg_catalog.setval('public.calificaciones_resumen_calificacion_resumen_id_seq', 6974, true);
...
SELECT pg_catalog.setval('public.levantamientos_levantamiento_id_seq', 2087, true);
...
SELECT pg_catalog.setval('public.tiendas_tienda_id_seq', 197, true);
