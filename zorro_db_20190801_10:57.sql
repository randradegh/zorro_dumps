...
SELECT pg_catalog.setval('public.calificaciones_resumen_calificacion_resumen_id_seq', 1926, true);
...
SELECT pg_catalog.setval('public.levantamientos_levantamiento_id_seq', 1513, true);
